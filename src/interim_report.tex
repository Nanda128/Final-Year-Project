...
\begin{document}
    ...
    The project will begin with a deep survey of Digital Twins, Drone-Swarm coordination, Maritime SAR\@.
    ...
    Testing the system in real-world deployments would be logistically impossible given the scope of this project, but it does pose an interesting subject to perform future studies on.
    ...
    It should also be necessary for all operational decisions to involve human support and assent.
    ...
    This interim report has presented the methodology and design process towards building a digital twin framework to enable effective human supervision of autonomous drone swarms in MSAR operations.
    ...
    This report can also act as the foundation for future research on this topic, such as real-world deployment.
