...
\begin{document}
    ...
    Recent work in 2024 in ~\cite{messmer2024uav} and ~\cite{UAV_USV_SAR} expanded this to practical MSAR implementations, developing a comprehensive software framework combining onboard UAV detection with ground-station processing to reduce operator visual strain.
    It addressed critical practical challenges like bandwidth restrictions, which are typical in MSAR operations in remote areas and open ocean.
